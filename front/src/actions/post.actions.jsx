...
export const addComment = (postId, commenterId, text, commenterPseudo) => {
  return (dispatch) => {
    return axios({
      method: 'patch',
      url: `http://localhost:3000/api/post/${postId}/comment-post`,
      withCredentials: true,
...
export const editComment = (postId, commentId, text, access) => {
  return (dispatch) => {
    return axios({
      method: 'patch',
      url: `http://localhost:3000/api/post/${postId}/edit-comment-post`,
      withCredentials: true,
...
export const deleteComment = (postId, commentId, access) => {
  return (dispatch) => {
    return axios({
      method: 'patch',
      url: `http://localhost:3000/api/post/${postId}/delete-comment-post`,
      withCredentials: true,
